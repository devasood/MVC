...
function addResults() {
	...
	var text="<table id=\"result\"><tr><th>UPC</th><th>Manufacturer</th><th>Brand</th><th>Update</th><th>Delete</th></tr>";
		...
		if("${s10}".length>0)
		text+="<tr><td>${s10}</td><td>${s11}</td><td>${s12}</td><td><a class=\"linksTable\" onClick=\"updateRec(${s00})\">Update</a></td><td><a class=\"linksTable\" onClick=\"deleteRec(${s10})\">Delete</a></td></tr>";
		if("${s20}".length>0)
		text+="<tr><td>${s20}</td><td>${s21}</td><td>${s22}</td><td><a class=\"linksTable\" onClick=\"updateRec(${s00})\">Update</a></td><td><a class=\"linksTable\" onClick=\"deleteRec(${s20})\">Delete</a></td></tr>";
		if("${s30}".length>0)
		text+="<tr><td>${s30}</td><td>${s31}</td><td>${s32}</td><td><a class=\"linksTable\" onClick=\"updateRec(${s00})\">Update</a></td><td><a class=\"linksTable\" onClick=\"deleteRec(${s30})\">Delete</a></td></tr>";
		if("${s40}".length>0)
		text+="<tr><td>${s40}</td><td>${s41}</td><td>${s42}</td><td><a class=\"linksTable\" onClick=\"updateRec(${s00})\">Update</a></td><td><a class=\"linksTable\" onClick=\"deleteRec(${s40})\">Delete</a></td></tr>";
		if("${s50}".length>0)
		text+="<tr><td>${s50}</td><td>${s51}</td><td>${s52}</td><td><a class=\"linksTable\" onClick=\"updateRec(${s00})\">Update</a></td><td><a class=\"linksTable\" onClick=\"deleteRec(${s50})\">Delete</a></td></tr>";
		if("${s60}".length>0)
		text+="<tr><td>${s60}</td><td>${s61}</td><td>${s62}</td><td><a class=\"linksTable\" onClick=\"updateRec(${s00})\">Update</a></td><td><a class=\"linksTable\" onClick=\"deleteRec(${s60})\">Delete</a></td></tr>";
		if("${s70}".length>0)
		text+="<tr><td>${s70}</td><td>${s71}</td><td>${s72}</td><td><a class=\"linksTable\" onClick=\"updateRec(${s00})\">Update</a></td><td><a class=\"linksTable\" onClick=\"deleteRec(${s70})\">Delete</a></td></tr>";
		if("${s80}".length>0)
		text+="<tr><td>${s80}</td><td>${s81}</td><td>${s82}</td><td><a class=\"linksTable\" onClick=\"updateRec(${s00})\">Update</a></td><td><a class=\"linksTable\" onClick=\"deleteRec(${s80})\">Delete</a></td></tr>";
		if("${s90}".length>0)
		text+="<tr><td>${s90}</td><td>${s91}</td><td>${s92}</td><td><a class=\"linksTable\" onClick=\"updateRec(${s00})\">Update</a></td><td><a class=\"linksTable\" onClick=\"deleteRec(${s90})\">Delete</a></td></tr>";
		text+="</table>";
	sr.innerHTML+=text;
	sr.innerHTML+=empty;
...
<td class="links">Goto Page: <input id="jump" name="Page" form="search" type="number" value="1" min="1" /></td>
</tr>
</table>
